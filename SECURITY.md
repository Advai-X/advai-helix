...
We will acknowledge a complete report as soon as practical, investigate it, and coordinate disclosure and remediation with the reporter when appropriate.

## Supported versions

Security fixes are delivered through the latest Helix Work release. Users should update to the newest available version before reporting an issue that may already have been resolved.

## Scope

Security reports may include issues involving:

- application signing, update, or package integrity;
- unintended access to local files, credentials, or task data;
